...
export class VideoChatService {
  ...
  startConnection(){
    this.hubConnection = new HubConnectionBuilder()
      ...
      this.hubConnection.on("RecieveAnswer", (senderId, answer) => {
  ...
  sendOffer(receiverId:string, answer:RTCSessionDescription){
    this.hubConnection.invoke("SendOffer", receiverId, JSON.stringify(answer));
  }
